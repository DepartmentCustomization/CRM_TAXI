(function () {
    return {
      ...
      afterViewInit: function() {
          ...
          let fileLabelText = this.createElement('div', { id: 'fileChooserText', className: 'btn', innerText: '1. Выбрать файл'});
          ...
          let btnImportFile = this.createElement('div', {disabled: true,  className: 'btn', id: 'btnImportFile',  innerText: '2. Загрузить файл' }, btnImportFile__triangle);
          
          let showTable__triangle  = this.createElement('div', {className: 'triangle showTable__triangle' });
          let btnShowTable = this.createElement('div', { className: 'btn', id: 'btnShowTable',  innerText: '3. Показать таблицу' },showTable__triangle);
